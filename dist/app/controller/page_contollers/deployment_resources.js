...
exports.add_mapeo_parametros =
  exports.ask_input_arguments =
  exports.ask_deployment_resources =
  exports.ask_deployment_resources_select =
  exports.mod_deployment_resources =
  exports.del_deployment_resources =
  exports.add_deployment_resources =
  exports.deployment_resources =
  exports.deployment_resources_page =
    void 0;
...
function deployment_resources(req, res) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if ((_a = req.session) === null || _a === void 0 ? void 0 : _a.user) {
      ...
      var impRes = new selfAwarnessModels_1.ImplementationResourceQ(
        -1,
        "",
        "",
        ""
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if ((_a = req.session) === null || _a === void 0 ? void 0 : _a.user) {
      ...
      if (data.tipoRecurso == "0") {
        var formula = new selfAwarnessModels_1.FormulaQ(
          -1,
          data.nombre,
        ...
        var funcion = new selfAwarnessModels_1.FunctionQ(
          -1,
          data.nombre,
          data.descripcion.replace(/'/g, "\\'"),
          data.EspecificoTipo.datoSalida,
        ...
        var service = new selfAwarnessModels_1.WebServiceQ(
          -1,
          data.nombre,
          data.descripcion.replace(/'/g, "\\'"),
          data.EspecificoTipo.datoSalida,
    ...
    if ((_a = req.session) === null || _a === void 0 ? void 0 : _a.user) {
      ...
      for (var i = 0; i < data.arregloParametros.length; i++) {
        ...
        if (param.id == undefined) {
          ...
          param.parametroEliminar.forEach((elem) =>
...
function ask_deployment_resources(req, res) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    if ((_a = req.session) === null || _a === void 0 ? void 0 : _a.user) {
      ...
      var parameter = new selfAwarnessModels_1.ParameterQ(
        -1,
        -1,
        "",
        -1,
      ...
      if (rows[0][0].tipo_recurso == 0) {
        ...
        var functio = new selfAwarnessModels_1.FunctionQ(
          -1,
          "",
          "",
          "",
        ...
        var webService = new selfAwarnessModels_1.WebServiceQ(
          -1,
          "",
          "",
          "",
...
function ask_input_arguments(req, res) {
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    var modelID =
      (_a = req.session) === null || _a === void 0
        ? void 0
        : _a.active_model.modelID;
