...
class database2 {
  ...
  architecture(architecture, modelID) {
    return __awaiter(this, void 0, void 0, function* () {
      yield this.insertar_sistemas_recursivo(
        modelID,
        "NULL",
      ...
      for (var i = 0; i < dataFlows.length; i++) {
        var insertedFlow = yield this.qwerty(
  ...
  insertar_sistemas_recursivo(modelID, idPadre, system) {
    return __awaiter(this, void 0, void 0, function* () {
      var architectureFather = yield this.qwerty(
        system.toSqlInsert(
          ["/@/MODELO/@/", "/@/PADRE/@/"],
          [modelID, `${idPadre}`]
        )
    ...
    return __awaiter(this, void 0, void 0, function* () {
      for (var i = 0; i < entidades.length; i++) {
        ...
        if (entidades[i].subEntity.length > 0) {
          ...
          yield this.insertar_entidades_recursivo(
            entidades[i].subEntity,
            valueAux
          );
        }
        yield this.relation_sujeto_objeto(
          entidades[i].id.toString(),
