...
function cargar_recursos_de_implementacion() {
    consultar_api(
        (url = "http://alvapala.ddns.net:3001/api/deployment_resources"),
...
function modificar_recurso() {
    ...
    if (id) {
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/ask_deployment_resources/", {
                id: id,
            },
...
function modificarRecursoImplementacion() {
    post_api(
        "http://alvapala.ddns.net:3001/api/del_deployment_resources/", {
...
function cargar_datos_recursos_modificar(tipo, datos_especificos) {
    if (tipo == "0") {
        document.getElementById("area_de_nueva_formula").value =
            datos_especificos.formula;
        document.getElementById(
            "selectTipoSalidaFormulaRecursoAdd"
        ).selectedIndex = indexOfValueinSelect(
            "#selectTipoSalidaFormulaRecursoAdd",
            datos_especificos.datoSalida
        );
    } else if (tipo == "1") {
        document.getElementById("area_de_nueva_istruccion_funcion").value =
            datos_especificos.instrucciones;
        document.getElementById(
        ...
        document.getElementById(
            "selectFormatodeSalida"
        ).selectedIndex = indexOfValueinSelect(
            "#selectFormatodeSalida",
            datos_especificos.formatoSalida
        );
    }
}
...
function guardarRecursoImplementacion() {
    ...
    if (tipoRecurso) {
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/add_deployment_resources/",
            data,
            (res) => {
                cargar_recursos_de_implementacion();
            },
...
if (document.getElementById("lista_sujetos_para_cargar"))
    consultar_api(
        "http://alvapala.ddns.net:3001/api/subjects",
        cargar_posibles_sujetos_modelo,
        error_cargar_posibles_sujetos_modelo
    );
...
function actualizar_activos() {
    ...
    post_api(
        (url = "http://alvapala.ddns.net:3001/api/update_subjects"),
        actualizacion,
        (json) => {
            console.log(json);
        },
...
function cargar_select_criterios_decision() {
    consultar_api(
        "http://alvapala.ddns.net:3001/api/decision_criteria",
...
function cargar_arbol(id) {
    post_api(
        (url = "http://alvapala.ddns.net:3001/api/subjects_objects"), {
            id: id,
        },
        (json) => {
...
function agregarObjeto() {
    ...
    if ((!!id_padre, !!nombre, !!descripcion, !!peso, !!operador)) {
        ...
        post_api(
            (url = "http://alvapala.ddns.net:3001/api/save_subjects_objects"), {
                father: id_padre,
                name: nombre,
...
function eliminarObjeto() {
    ...
    post_api(
        (url = "http://alvapala.ddns.net:3001/api/delete_subjects_objects"), {
            id: id,
        },
        (json) => {
            alert(json.Mensaje);
...
function guardarNuevaUnidadMedida() {
    ...
    if (!!data.name && !!data.description && !!data.acronym) {
        post_api(
            "http://alvapala.ddns.net:3001/api/add_measurement_units/",
            data,
...
function GuardarEliminarUnidadMedida() {
    ...
    if (!!id) {
        if (confirm("Esta seguro que desea eliminar la unidad de Medida")) {
            post_api(
                "http://alvapala.ddns.net:3001/api/del_measurement_units/", { id: id },
                data,
                mensaje_exitoEnvioUnidadesMedida,
                mensaje_errorEnvioUnidadesMedida
            );
...
function GuardareliminarEscala() {
    ...
    if (!!id) {
        if (confirm("Esta seguro de que desea eliminar la escala")) {
            post_api(
                "http://alvapala.ddns.net:3001/api/del_scales/", { id: id },
                mensaje_exitoEnvioEscalas,
                mensaje_errorEnvioEscalas
            );
        }
...
function guardarModificacionEscala() {
    ...
    if (!!data.id && !!data.name && !!data.valid_values && !!data.type) {
        post_api(
            "http://alvapala.ddns.net:3001/api/upd_scales/",
            data,
            mensaje_exitoEnvioEscalas,
            mensaje_errorEnvioEscalas
        );
...
function get_criterios_table() {
    consultar_api(
        "http://alvapala.ddns.net:3001/api/get_criteria",
...
function guardarNuevoCriterio() {
    ...
    if (!!data.name && !!data.description) {
        post_api(
            "http://alvapala.ddns.net:3001/api/add_criteria/",
            data,
    ...
    try {
        ...
        if (!!id) {
            if (confirm("Esta seguro que desea eliminar el criterio de decision")) {
                ...
                post_api(
                    "http://alvapala.ddns.net:3001/api/del_criteria/",
                    data,
                    mensaje_exitoEnvioDecisionCriteria,
                    mensaje_errorEnvioDecisionCriteria
                );
...
function guardarModificacionCriterios() {
    try {
        ...
        if (!!data.id && !!data.name && !!data.description) {
            post_api(
                "http://alvapala.ddns.net:3001/api/upd_criteria/",
                data,
                mensaje_exitoEnvioDecisionCriteria,
                mensaje_errorEnvioDecisionCriteria
            );
...
function guardarNuevoUmbral() {
    try {
        ...
        if (!!data.nombre &&
            ...
            post_api(
                "http://alvapala.ddns.net:3001/api/add_umbral/",
                data,
...
function guardar_eliminar_umbral() {
    ...
    if (!!id) {
        if (confirm("Esta seguro que desea eliminar este Umbral")) {
            post_api(
                "http://alvapala.ddns.net:3001/api/del_umbral/", { id: id },
                mensaje_exitoEnvioUmbral,
                mensaje_errorEnvioUmbral
            );
        }
...
function guardarNuevoAspecto() {
    ...
    if (!!data.descripcion) {
        ...
        consultar_api(
            "http://alvapala.ddns.net:3001/api/aspects",
...
if (document.getElementById("tabla_modelos_autoconciencia"))
    consultar_api(
        "http://alvapala.ddns.net:3001/api/user_models",
        cargar_modelos_table,
        error_cargar_models_table
    );
...
function actualizar_activos_entidad() {
    ...
    post_api(
        (url = "http://alvapala.ddns.net:3001/api/update_entity"),
        actualizacion,
        (json) => {
            console.log(json);
        },
...
function EliminarAspecto() {
    ...
    if (!!id) {
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/del_aspects/",
            data,
            mensaje_exitoEnvioAspects,
            mensaje_errorEnvioAspects
        );
...
function eliminar_metrica() {
    ...
    if (!!id) {
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/del_metrica/",
            data,
...
function guardarNuevaRecImpl() {
    ...
    if (!!data.nombre &&
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/add_ri/",
            data,
...
function eliminar_recurso_implementacion() {
    ...
    if (!!id) {
        ...
        console.log(data);
        post_api(
            "http://alvapala.ddns.net:3001/api/del_escales/",
            data,
            mensaje_exitoEnvioEscalas,
            mensaje_errorEnvioEscalas
        );
...
function guardarModificacionRI() {
    ...
    if (!!data.id && !!data.nombre && !!data.valor_valido && !!data.tipo) {
        post_api(
            "http://alvapala.ddns.net:3001/api/upd_escales/",
            data,
            mensaje_exitoEnvioEscalas,
            mensaje_errorEnvioEscalas
        );
...
if (document.getElementById("tabla_recurso_implementacion"))
    consultar_api(
        "http://alvapala.ddns.net:3001/api/recurso_implementacion",
        cargar_ri_table,
        error_cargar_ri_table
    );
...
function generar_flujo_datos_select() {
    var tipoComununicacionSeleccionado = document.getElementById(
        "tipo_comunicacion"
    );
    comunicacion =
        tipoComununicacionSeleccionado.options[
            tipoComununicacionSeleccionado.selectedIndex
        ].text;
    var porpiedadSeleccionada = document.getElementById("proiedad_recoleccion")
        .value;
    if (comunicacion != "Seleccione.." && porpiedadSeleccionada != "-6") {
        post_api(
            "http://alvapala.ddns.net:3001/api/get_flujo_datos/", {
...
function cargar_aspectos(elemento, lado) {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/properties", {
            id: idObjeto,
        },
...
$("#Aspectos_autoconsciencia").change(function() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/get_metrica_select",
        data,
...
function visibilidad_acciones_umbral(id) {
    ...
    document
        ...
        .classList.replace("d-none", "inline-block");
    post_api(
        "http://alvapala.ddns.net:3001/api/get_accion/", {
            id: id,
        },
        cargar_accion_table,
        (res) => {
...
function guardarAccionUmbral() {
    post_api(
        "http://alvapala.ddns.net:3001/api/get_metodo_aprendizaje", {
            id: 22,
        },
...
function enviarDatos_acciones_umbrales(json) {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/add_accion",
        data,
...
function eliminarAccionesUmbrales() {
    ...
    if (!!id) {
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/del_accion/",
            data,
...
function guardarModificacionAccionesUmbrales() {
    var data = {
        ...
        descripcion: document.getElementById("descripcion_accion_umbral_modificar")
            .value,
        activo: document.getElementById("activo_accion_umbral_modificar").checked,
    };
    post_api(
        "http://alvapala.ddns.net:3001/api/upd_acciones_umbrales/",
        data,
        (res) => {
            console.log(res);
        },
...
function cargar_metricas_tipo_mapeo(elemento) {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/ask_input_arguments",
        data,
...
function SeleccionaRecursoSelect(element) {
    ...
    if (element.value) {
        post_api(
            "http://alvapala.ddns.net:3001/api/ask_deployment_resources_select/", {
                tipo: element.value,
            },
...
function guardar_procesos_pre_reflexivos() {
    var nombre = document.getElementById("input-name-proceso-pre-reflexivo")
        .value;
...
function guardar_modelos_metodos() {
    ...
    if (
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/add_metodo_modelo",
            datos,
...
if (document.getElementById("tabla_proceso_pre_reflexivo"))
    consultar_api(
        "http://alvapala.ddns.net:3001/api/procesos_pre_reflexive",
...
function modificarProcesoPreReflexivo() {
    ...
    if (!!id) {
        post_api(
            "http://alvapala.ddns.net:3001/api/procesos_pre_reflexive_id/", {
                id: id,
            },
...
function elminarProcesoPreReflexivo() {
    ...
    if (!!id) {
        if (confirm("Esta seguro de que desea eliminar el Proceso")) {
            ...
            post_api(
                "http://alvapala.ddns.net:3001/api/del_process_pre_reflexive/",
                data,
...
function Guagar_nuevo_Mapeo() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/add_mapeo_parametros/",
        aux,
...
if (document.getElementById("tabla_proceso_reflexivo"))
    consultar_api(
        "http://alvapala.ddns.net:3001/api/procesos_reflexive",
...
function guardar_modelos_metodos_reflexivos() {
    ...
    if (
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/add_metodo_modelo_reflexivos",
            datos,
...
function cargar_select_mapeo_variables_simulacion(json) {
    console.log(json);
    consultar_api(
        "http://alvapala.ddns.net:3001/api/get_variable_simulacion",
...
function modificar_proceso_pre_reflexivo() {
    ...
    if (!!nombre && !!descripcion && !!inicio && !!fin) {
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/mod_process_pre_reflexive/",
            data,
...
function recuperar_ultimo_metodo_aprendizaje_escenario() {
    post_api(
        "http://alvapala.ddns.net:3001/api/get_metodo_aprendizaje", { id: 23 },
...
function consultar_tabla_escenarios(json) {
    post_api(
        "http://alvapala.ddns.net:3001/api/ascenario_simulacion", { mea_id: json.id },
...
function enviarDatos_escenarios_simulacion(json) {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/add_escenario_simulacion",
        data,
...
function eliminar_escenario_simulacion() {
    ...
    if (!!id) {
        post_api(
            "http://alvapala.ddns.net:3001/api/del_escenario_simulacion/", {
                id: id,
            },
            (res) => {
                console.log(res);
...
function ModificarEscenarioSimulacions() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/upd_escenario_simulacion/",
        data,
        (res) => {
            console.log(res);
        },
...
function consultar_tabla_valores_variables(id) {
    post_api(
        "http://alvapala.ddns.net:3001/api/get_variables_valor/", {
            id: id,
        },
...
function consultar_variables_select(json) {
    post_api(
        "http://alvapala.ddns.net:3001/api/get_variable_simulacion/", { mea_id: json.id },
...
function enviarDatos_variables_simulacion(json) {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/add_variable_simulacion/", {
            nombre: nombre,
            mea_id: json.id,
        },
...
function eliminar_variables_simulacion() {
    ...
    if (!!id) {
        post_api(
            "http://alvapala.ddns.net:3001/api/del_variable_simulacion/", {
                id: id,
            },
            (res) => {
                console.log(res);
...
function ModificarVariableSimulacions() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/upd_variable_simulacion/",
        data,
        (res) => {
            console.log(res);
        },
...
function guardarvariables_valor() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/add_variables_valor/",
        data,
...
function agregarMetrica() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/get_enumeracion", { tipo: "TIPO_METRICA" },
        cargar_tipo_metrica_select,
        error_cargar_tipo_metrica_select
    );
}
...
function GuardarMetrica() {
    ...
    var data = {
        ...
        perspective: document.getElementById("perspectiva_indicador").value,
        scale: escala,
        unit: unidad,
        type_metric: tipo,
    ...
    if (!!data.name &&
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/add_metrics/",
            data,
            mensaje_exitoEnvioMetrica,
            mensaje_errorEnvioMetrica
        );
...
function cargar_tabla_metricas() {
    consultar_api(
        "http://alvapala.ddns.net:3001/api/get_metrics",
...
function Guardar_Modificacion_Metrica() {
    ...
    if (!!data.id &&
        ...
        post_api(
            "http://alvapala.ddns.net:3001/api/mod_metrics/",
            data,
            mensaje_exitoEnvioMetrica,
            mensaje_errorEnvioMetrica
        );
...
function eliminarMetrica() {
    ...
    if (!!id) {
        if (confirm("Esta seguro de que desea eliminar el recurso")) {
            post_api(
                "http://alvapala.ddns.net:3001/api/del_metrics/", {
                    id: id,
                },
                (res) => {
                    console.log(res);
...
function cargar_tabla_aspectos() {
    consultar_api(
        "http://alvapala.ddns.net:3001/api/get_aspects",
        cargar_aspectos_table,
        error_cargar_aspectos_table
    );
}
...
function cargar_aspectos_table(json) {
    ...
    json.forEach((met) => {
      ...
      data-activo="${met.active == 1}" data-objeto="${met.obj}" data-sujeto="${
      met.suj
    }" data-modelo="${met.model}"></td>`;
        res += `<td>${met.id}</td>`;
        res += `<td>${met.name}</td>`;
        res += `<td>${met.description}</td>`;
...
function llenar_listado_metricas(id) {
    post_api(
        "http://alvapala.ddns.net:3001/api/get_metrics", { id: id },
...
function agregar_metrica_seleccionado() {
    ...
    post_api(
        "http://alvapala.ddns.net:3001/api/add_metrics_aspects",
        metricasSeleccion,
...
function modficarAspectos() {
    ...
    radio.forEach((elem) => {
        if (elem.checked) {
            ...
            tipo = elem.dataset.tipo;
            active = elem.dataset.activo == "true";
            obj = elem.dataset.objeto;
            suj = elem.dataset.sujeto;
            return;
        }
    });
    if (!!id && !!name && !!descripcion && !!peso) {
        consultar_api(
            "http://alvapala.ddns.net:3001/api/subjects",
            cargar_sujetos_activos_aspectos_modificar,
            error_cargar_sujetos_activos_aspectos_modificar
        );
        ...
        document.getElementById("objeto_id_aspecto").value = obj;
...
function cargar_sujetos_activos_aspectos_modificar(json) {
    var aux_visible_activo = new Set();
    var aux_visible_inactivo = new Set();
    json.forEach((elemento) => {
        if (!!elemento.padre && elemento.activo == 1) {
    ...
    var idModificar = document.getElementById("sujeto_id_aspecto").value;
    json.forEach((elemento) => {
        var insertar;
        if (!elemento.padre) {
            insertar = document.getElementById("lista_sujetos_activos_aspectos_mod");
        } else {
            insertar = document.createElement("ul");
            document
                .getElementById(`li_entidad_seleccionado_${elemento.padre}`)
