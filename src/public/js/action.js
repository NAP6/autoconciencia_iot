...
function consultar_get_unidades_medida() {
    consultar_api(
        "http://alvapala.ddns.net:3000/api/get_measurement_units",
...
function cargar_unidades_de_medida_table(json) {
    ...
    json.forEach((um) => {
      ...
      um.description
    }" data-acronym="${um.acronym}" data-activo="${
      um.active == "true"
    }"></td>`;
        res += `<td>${um.id}</td>`;
        res += `<td>${um.name}</td>`;
...
function recuperar_ultimo_metodo_aprendizaje_escenario() {
    post_api(
        "http://alvapala.ddns.net:3000/api/get_metodo_aprendizaje", { id: 23 },
...
function consultar_tabla_escenarios(json) {
    post_api(
        "http://alvapala.ddns.net:3000/api/ascenario_simulacion", { mea_id: json.id },
...
function consultar_variables_select(json) {
    post_api(
        "http://alvapala.ddns.net:3000/api/get_variable_simulacion/", { mea_id: json.id },
...
function agregarMetrica() {
    ...
    post_api(
        "http://alvapala.ddns.net:3000/api/get_enumeracion", { tipo: "TIPO_METRICA" },
        cargar_tipo_metrica_select,
        error_cargar_tipo_metrica_select
    );
}
...
function GuardarMetrica() {
    ...
    if (!!data.name &&
        ...
        post_api(
            "http://alvapala.ddns.net:3000/api/add_metrics/",
            data,
            mensaje_exitoEnvioMetrica,
            mensaje_errorEnvioMetrica
        );
...
function cargar_tabla_metricas() {
    consultar_api(
        "http://alvapala.ddns.net:3000/api/get_metrics",
...
function Guardar_Modificacion_Metrica() {
    ...
    if (!!data.id &&
        ...
        post_api(
            "http://alvapala.ddns.net:3000/api/mod_metrics/",
            data,
            mensaje_exitoEnvioMetrica,
            mensaje_errorEnvioMetrica
        );
...
function eliminarMetrica() {
    ...
    if (!!id) {
        if (confirm("Esta seguro de que desea eliminar el recurso")) {
            post_api(
                "http://alvapala.ddns.net:3000/api/del_metrics/", {
                    id: id,
                },
                (res) => {
                    console.log(res);
...
function cargar_tabla_aspectos() {
    consultar_api(
        "http://alvapala.ddns.net:3000/api/get_aspects",
        cargar_aspectos_table,
        error_cargar_aspectos_table
    );
}
...
function llenar_listado_metricas(id) {
    post_api(
        "http://alvapala.ddns.net:3000/api/get_metrics", { id: id },
...
function agregar_metrica_seleccionado() {
    ...
    post_api(
        "http://alvapala.ddns.net:3000/api/add_metrics_aspects",
        metricasSeleccion,
