...
function get_tipo_escalas_select() {
    post_api(
        "http://alvapala.ddns.net:3000/api/get_enumeracion", { tipo: "TIPO_ESCALA" },
...
function cargar_activos_umbrales() {
    ...
    post_api(
        "http://alvapala.ddns.net:3000/api/get_umbral", { criterio: seleccionCriterio },
...
function elminarProcesoPreReflexivo() {
    ...
    if (!!id) {
        if (confirm("Esta seguro de que desea eliminar el Proceso")) {
            post_api(
                "http://alvapala.ddns.net:3000/api/del_pre_reflective_process/", { id: id },
...
function consultar_tabla_escenarios() {
    post_api(
        "http://alvapala.ddns.net:3000/api/get_simulation_scenario", { mea_id: metodo_calculo },
...
function consultar_variables_select(mea_id) {
    post_api(
        "http://alvapala.ddns.net:3000/api/get_simulation_variable/", { mea_id: mea_id },
...
function get_aspectos_objetivos(id) {
    post_api(
        "http://alvapala.ddns.net:3000/api/subjects_objects", { id: id },
...
function cargar_select_aspectos_objetivos_modificar(json) {
    ...
    if (!!id && !!name && !!descripcion && !!peso) {
        ...
        post_api(
            "http://alvapala.ddns.net:3000/api/get_aspects_subjects", { id: id },
