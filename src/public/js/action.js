...
function cargar_select_tipo_dato_salida(json) {
    ...
    document.getElementById("selectTipoSalidaFormulaRecursoAdd").innerHTML = ope.innerHTML;
    document.getElementById("selectTipoSalidaFuncionesRecursoAdd").innerHTML = ope.innerHTML;
    document.getElementById("selectTipoSalidaServiciosRecursoAdd").innerHTML = ope.innerHTML;
    document.querySelector("#parametro_formula #tipo_dato_parametro").innerHTML = ope.innerHTML;
    document.querySelector("#parametro_funciones #tipo_dato_parametro").innerHTML = ope.innerHTML;
    document.querySelector("#parametro_servicios #tipo_dato_parametro").innerHTML = ope.innerHTML;
}
...
function agregar_parametro(tipo) {
    ...
    var botonModificar = document.querySelector(`#${tipo} #btn-modificarParametro`);
    ...
    var formularioP = document.querySelector(`#${tipo} #parametros #formulario_parametros`);
...
function guardar_parametro(tipo) {
    ...
    var tipoIndex = document.querySelector(`#${tipo} #tipo_dato_parametro`).selectedIndex
    ...
    document.querySelector(`#${tipo} #lista_parametros_recursos`).appendChild(seccion);
...
function pintar_parametro(id, tipo) {
    if (parametro_seleccionado) {
        document.querySelector(`#${tipo} #${parametro_seleccionado.id}`).style.color = "";
    }
    if (!parametro_seleccionado ||
        parametro_seleccionado.id != id
    ) {
        parametro_seleccionado = {
            id: id,
        };
        var botton = document
            .querySelector(`#${tipo} #${id}`);
...
function modificar_parametro(tipo) {
    if (parametro_seleccionado) {
        var elegido = document.querySelector(`#${tipo} #${parametro_seleccionado.id}`);
        document.querySelector(`#${tipo} #ordinalParametro`).value = elegido.dataset.ordinal;
        document.querySelector(`#${tipo} #nombreParametro`).value = elegido.dataset.nombre;
        document.querySelector(`#${tipo} #opcional_parametro`).checked = elegido.dataset.opcional == "true";
        document.querySelector(`#${tipo} #activo_parametro`).checked = elegido.dataset.activo == "true";
        document.querySelector(`#${tipo} #tipo_dato_parametro`).selectedIndex = elegido.dataset.tipoIndex;
...
function guardar_modificar_parametro(tipo) {
    var elegido = document.querySelector(`#${tipo} #${parametro_seleccionado.id}`);
    elegido.dataset.ordinal = document.querySelector(`#${tipo} #ordinalParametro`).value;
    elegido.dataset.nombre = document.querySelector(`#${tipo} #nombreParametro`).value;
    elegido.dataset.opcional = document.querySelector(`#${tipo} #opcional_parametro`).checked;
    elegido.dataset.activo = document.querySelector(`#${tipo} #activo_parametro`).checked;
...
function eliminar_parametro(tipo) {
    if (parametro_seleccionado) {
        if (confirm("Esta seguro de eliminar el parametro")) {
            var elemento = document.querySelector(`#${tipo} #${parametro_seleccionado.id}`);
...
function limpiar_add_recusos() {
    ...
    document.querySelector("#parametro_formula #lista_parametros_recursos").innerHTML = "";
    document.querySelector("#parametro_funciones #lista_parametros_recursos").innerHTML = "";
    document.querySelector("#parametro_servicios #lista_parametros_recursos").innerHTML = "";
